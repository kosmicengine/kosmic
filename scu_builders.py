...
def generate_scu_files(max_includes_per_scu):
    ...
    process_folder(["modules/kosmic_physics_2d"])
    process_folder(["modules/kosmic_physics_3d"])
    process_folder(["modules/kosmic_physics_3d/joints"])

    process_folder(["modules/csg"])
    process_folder(["modules/voyscript"])
    process_folder(["modules/voyscript/editor"])
    process_folder(["modules/voyscript/language_server"])
