...
if (
    ...
    print("FATAL ERROR: Kosmic has been crashed.")
    sys.exit(52)

# Finding memory leaks in Kosmic is quite difficult, because we need to take into
...
# It may happen that Kosmic detects leaking nodes/resources and removes them, so
...
# For now Kosmic leaks a lot of rendering stuff so for now we just show info
