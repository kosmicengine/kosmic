...
def configure(env: "SConsEnvironment"):
    ...
    if not has_swappy:
        print_warning(
            "Swappy Frame Pacing not detected! It is strongly recommended you download it from https://github.com/darksylinc/kosmic-swappy/releases and extract it so that the following files can be found:\n"
    ...
    env.Append(LINKFLAGS=["-Wl,-soname,libkosmic_android.so"])
