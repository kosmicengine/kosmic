...
def create_engine_file(env, target, source, externs, threads_enabled):
    ...
    subst_dict = {"___KOSMIC_THREADS_ENABLED": "true" if threads_enabled else "false"}
...
def create_template_zip(env, js, wasm, side):
    ...
    if env.editor_build:
        ...
        subst_dict = {
            ...
            "___KOSMIC_CACHE___": json.dumps(cache),
            "___KOSMIC_OPT_CACHE___": json.dumps(opt_cache),
            "___KOSMIC_OFFLINE_PAGE___": "offline.html",
