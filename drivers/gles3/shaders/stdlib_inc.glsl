// Compatibility renames. These are exposed with the "kosmic_" prefix
// to work around two distinct Adreno bugs:
// 1. Some Adreno devices expose ES310 functions in ES300 shaders.
//    Internally, we must use the "kosmic_" prefix, but user shaders
...
#define packUnorm4x8 kosmic_packUnorm4x8
#define unpackUnorm4x8 kosmic_unpackUnorm4x8
#define packSnorm4x8 kosmic_packSnorm4x8
#define unpackSnorm4x8 kosmic_unpackSnorm4x8
