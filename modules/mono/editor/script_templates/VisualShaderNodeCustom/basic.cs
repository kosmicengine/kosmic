...
public partial class VisualShaderNode_CLASS_ : _BASE_
{
    ...
    public override string _GetCode(Kosmic.Collections.Array<string> inputVars, Kosmic.Collections.Array<string> outputVars, Shader.Mode mode, VisualShader.Type type)
    {
        return "";
    }
}
