...
namespace KosmicTools.Build
{
    public static class BuildManager
    {
        ...
        {
            var dllName = $"{KosmicSharpDirs.ProjectAssemblyName}.dll";
            var path = Path.Combine(KosmicSharpDirs.ProjectBaseOutputPath, "Debug", dllName);
        ...
        {
            var plugin = KosmicSharpEditor.Instance;
        ...
        {
            var buildInfo = new BuildInfo(KosmicSharpDirs.ProjectSlnPath, KosmicSharpDirs.ProjectCsProjPath, configuration,
        ...
        public static bool EditorBuildCallback()
        {
            ...
            if (KosmicSharpEditor.Instance.SkipBuildBeforePlaying)
