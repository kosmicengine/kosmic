...
namespace KosmicTools.Build
{
    public static class BuildSystem
    {
        ...
        {
            var verbosityLevel =
                editorSettings.GetSetting(KosmicSharpEditor.Settings.VerbosityLevel).As<VerbosityLevelId>();
            arguments.Add("-v");
            ...
            if ((bool)editorSettings.GetSetting(KosmicSharpEditor.Settings.NoConsoleLogging))
        ...
        private static void AddBinaryLogArgument(BuildInfo buildInfo, Collection<string> arguments,
            EditorSettings editorSettings)
        {
            if (!(bool)editorSettings.GetSetting(KosmicSharpEditor.Settings.CreateBinaryLog))
                return;
        ...
        {
            var baseDylib = $"{KosmicSharpDirs.ProjectAssemblyName}.dylib";
            var baseSym = $"{KosmicSharpDirs.ProjectAssemblyName}.framework.dSYM";
