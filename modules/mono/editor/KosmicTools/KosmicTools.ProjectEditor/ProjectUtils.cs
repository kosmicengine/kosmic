...
namespace KosmicTools.ProjectEditor
{
    ...
    public static partial class ProjectUtils
    {
        ...
        public static void UpgradeProjectIfNeeded(MSBuildProject project, string projectName)
        {
            ...
            EnsureKosmicSdkIsUpToDate(project);
        ...
        private static void EnsureTargetFrameworkMatchesMinimumRequirement(MSBuildProject project)
        {
            ...
            foreach (var propertyGroup in root.PropertyGroups)
            {
                ...
                if (groupHasCondition && !ConditionMatchesKosmicPlatform(propertyGroup.Condition))
                {
                    continue;
                }
                ...
                foreach (var property in propertyGroup.Properties)
                {
                    ...
                    if (propertyHasCondition && !ConditionMatchesKosmicPlatform(property.Condition))
                    {
                        continue;
                    }
