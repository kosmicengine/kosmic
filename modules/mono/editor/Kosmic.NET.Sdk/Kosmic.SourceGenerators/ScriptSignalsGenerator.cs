...
namespace Kosmic.SourceGenerators
{
    ...
    public class ScriptSignalsGenerator : ISourceGenerator
    {
        ...
        )
        {
            ...
            foreach (var signalDelegateSymbol in signalDelegateSymbols)
            {
                ...
                var invokeMethodData = signalDelegateSymbol
                    .DelegateInvokeMethod?.HasKosmicCompatibleSignature(typeCache);
            ...
            if (godotSignalDelegates.Count > 0)
            {
                ...
                source.Append("        base.RaiseKosmicClassSignalCallbacks(signal, args);\n");
            ...
            if (godotSignalDelegates.Count > 0)
            {
                ...
                source.Append("        return base.HasKosmicClassSignal(signal);\n");
        ...
        private static MethodInfo DetermineMethodInfo(KosmicSignalDelegateData signalDelegateData)
        {
        ...
        private static void GenerateSignalEventInvoker(
            KosmicSignalDelegateData signal,
            StringBuilder source
        )
        {
