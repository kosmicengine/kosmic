...
namespace Kosmic.SourceGenerators
{
    internal static class ExtensionMethods
    {
        ...
        public static bool AreKosmicSourceGeneratorsDisabled(this GeneratorExecutionContext context)
            => context.TryGetGlobalAnalyzerProperty("KosmicSourceGenerators", out string? toggle) &&
               toggle != null &&
        ...
        public static bool IsKosmicSourceGeneratorDisabled(this GeneratorExecutionContext context, string generatorName) =>
            AreKosmicSourceGeneratorsDisabled(context) ||
            (context.TryGetGlobalAnalyzerProperty("KosmicDisabledSourceGenerators", out string? disabledGenerators) &&
        ...
        public static INamedTypeSymbol? GetKosmicScriptNativeClass(this INamedTypeSymbol classTypeSymbol)
        {
            var symbol = classTypeSymbol;

            while (symbol != null)
            {
                if (symbol.ContainingAssembly?.Name == "KosmicSharp")
                    return symbol;
        ...
        public static string? GetKosmicScriptNativeClassName(this INamedTypeSymbol classTypeSymbol)
        {
            var nativeType = classTypeSymbol.GetKosmicScriptNativeClass();
        ...
        )
        {
            ...
            if (classTypeSymbol?.BaseType == null
                || !classTypeSymbol.BaseType.InheritsFrom("KosmicSharp", KosmicClasses.KosmicObject))
            {
                symbol = null;
                return false;
            }
        ...
        public static IEnumerable<(ClassDeclarationSyntax cds, INamedTypeSymbol symbol)> SelectKosmicScriptClasses(
        ...
        )
        {
            ...
            {
                if (cds.TryGetKosmicScriptClass(compilation, out var symbol))
        ...
        public static bool IsKosmicExportAttribute(this INamedTypeSymbol symbol)
            => symbol.FullQualifiedNameOmitGlobal() == KosmicClasses.ExportAttr;
        ...
        )
        {
            ...
            {
                var methodData = HasKosmicCompatibleSignature(method, typeCache);
        ...
        public static IEnumerable<KosmicPropertyData> WhereIsKosmicCompatibleType(
        ...
        )
        {
            foreach (var property in properties)
            {
                ...
                yield return new KosmicPropertyData(property, marshalType.Value);
            }
        }

        public static IEnumerable<KosmicFieldData> WhereIsKosmicCompatibleType(
        ...
        )
        {
            ...
            {
                // TODO: We should still restore read-only fields after reloading assembly. Two possible ways: reflection or turn RestoreKosmicObjectData into a constructor overload.
                var marshalType = MarshalUtils.ConvertManagedTypeToMarshalType(field.Type, typeCache);

                if (marshalType == null)
                    continue;

                yield return new KosmicFieldData(field, marshalType.Value);
            }
        }
