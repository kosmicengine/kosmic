...
namespace Kosmic.SourceGenerators
{
    ...
    public class ScriptPropertyDefValGenerator : ISourceGenerator
    {
        ...
        )
        {
            ...
            bool isNode = symbol.InheritsFrom("KosmicSharp", KosmicClasses.Node);
            ...
            var exportedProperties = members
                ...
                .Where(s => s.GetAttributes()
                    .Any(a => a.AttributeClass?.IsKosmicExportAttribute() ?? false))
                .ToArray();
            ...
            // Generate GetKosmicExportedProperties
            ...
            if (exportedMembers.Count > 0)
            {
                ...
                const string DictionaryType =
                    "global::System.Collections.Generic.Dictionary<global::Kosmic.StringName, global::Kosmic.Variant>";
                ...
                source.Append(" GetKosmicPropertyDefaultValues()\n    {\n");
        ...
        {
            if (marshalType == MarshalType.KosmicObjectOrDerived)
            {
                return memberType.InheritsFrom("KosmicSharp", KosmicClasses.Node);
            }
            if (marshalType == MarshalType.KosmicObjectOrDerivedArray)
            {
                var elementType = ((IArrayTypeSymbol)memberType).ElementType;
                return elementType.InheritsFrom("KosmicSharp", KosmicClasses.Node);
            }
            if (memberType is INamedTypeSymbol { IsGenericType: true } genericType)
            {
                return genericType.TypeArguments
                    .Any(static typeArgument
                        => typeArgument.InheritsFrom("KosmicSharp", KosmicClasses.Node));
            }
