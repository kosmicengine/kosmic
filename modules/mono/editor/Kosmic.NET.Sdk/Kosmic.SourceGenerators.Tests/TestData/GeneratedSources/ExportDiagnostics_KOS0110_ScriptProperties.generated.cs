...
partial class ExportDiagnostics_KS0110
{
#pragma warning disable CS0109 // Disable warning about redundant 'new' keyword
    ...
    protected override bool SetKosmicClassPropertyValue(in kosmic_string_name name, in kosmic_variant value)
    {
        if (name == PropertyName.@MyButton) {
            this.@MyButton = global::Kosmic.NativeInterop.VariantUtils.ConvertTo<string>(value);
            return true;
        }
    ...
    {
        if (name == PropertyName.@MyButton) {
            value = global::Kosmic.NativeInterop.VariantUtils.CreateFrom<string>(this.@MyButton);
            return true;
        }
