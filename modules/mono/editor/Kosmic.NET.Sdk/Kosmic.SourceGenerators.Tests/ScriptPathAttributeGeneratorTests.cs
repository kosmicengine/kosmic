...
public class ScriptPathAttributeGeneratorTests
{
    ...
    {
        return (
            Path.Combine("Kosmic.SourceGenerators", "Kosmic.SourceGenerators.ScriptPathAttributeGenerator", "AssemblyScriptTypes.generated.cs"),
            SourceText.From($$"""
            [assembly:Kosmic.AssemblyHasScriptsAttribute(new System.Type[] {{{string.Join(", ", types.Select(type => $"typeof({type})"))}}})]
