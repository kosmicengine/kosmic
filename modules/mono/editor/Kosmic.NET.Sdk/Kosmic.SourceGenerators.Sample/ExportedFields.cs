...
namespace Kosmic.SourceGenerators.Sample
{
    ...
    public partial class ExportedFields : KosmicObject
    {
        ...
        [Export] private KosmicObject[] _fieldKosmicObjectOrDerivedArray = { null };
        ...
        // Classes
        [Export] private KosmicObject _fieldKosmicObjectOrDerived;
        [Export] private Kosmic.Texture _fieldKosmicResourceTexture;
        ...
        [Export]
        private Kosmic.Collections.Dictionary _fieldKosmicDictionary =
