...
namespace Kosmic.SourceGenerators.Sample
{
    ...
    public partial class ExportedProperties : KosmicObject
    {
        ...
        [Export] private KosmicObject[] PropertyKosmicObjectOrDerivedArray { get; set; } = { null };
        ...
        // Classes
        [Export] private KosmicObject PropertyKosmicObjectOrDerived { get; set; }
        [Export] private Kosmic.Texture PropertyKosmicResourceTexture { get; set; }
        ...
        [Export]
        private Kosmic.Collections.Dictionary PropertyKosmicDictionary { get; set; } =
