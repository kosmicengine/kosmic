...
namespace KosmicPlugins
{
    public static class Main
    {
        ...
        private static readonly Assembly CoreApiAssembly = typeof(global::Kosmic.KosmicObject).Assembly;
            ...
            IntPtr unmanagedCallbacks, int unmanagedCallbacksSize)
        {
            try
            {
                ...
                if (_editorHint)
                {
                    _editorApiAssembly = Assembly.Load("KosmicSharpEditor");
        ...
        {
            public unsafe delegate* unmanaged<char*, kosmic_string*, kosmic_bool> LoadProjectAssemblyCallback;
            public unsafe delegate* unmanaged<char*, IntPtr, int, IntPtr> LoadToolsAssemblyCallback;
            public unsafe delegate* unmanaged<kosmic_bool> UnloadProjectPluginCallback;
        }

        [UnmanagedCallersOnly]
        private static unsafe kosmic_bool LoadProjectAssembly(char* nAssemblyPath, kosmic_string* outLoadedAssemblyPath)
        {
            try
            {
                if (_projectLoadContext != null)
                    return kosmic_bool.True; // Already loaded
        ...
        [UnmanagedCallersOnly]
        private static kosmic_bool UnloadProjectPlugin()
        {
            try
            {
        ...
        private static bool UnloadPlugin(ref PluginLoadContextWrapper? pluginLoadContext)
        {
            try
            {
                ...
                while (pluginLoadContext.IsAlive)
                {
                    ...
                    if (!takingTooLong && elapsedTimeMs >= 200)
                    {
                        ...
                        // TODO: How to log from KosmicPlugins? (delegate pointer?)
            ...
            {
                // TODO: How to log exceptions from KosmicPlugins? (delegate pointer?)
                Console.Error.WriteLine(e);
                return false;
            }
        }
