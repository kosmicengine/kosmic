...
namespace Kosmic
{
    ...
    public static class StringExtensions
    {
        ...
        {
            using kosmic_string instanceStr = Marshaling.ConvertStringToNative(instance);
            NativeFuncs.kosmicsharp_string_to_camel_case(instanceStr, out kosmic_string camelCase);
            using (camelCase)
        ...
        {
            using kosmic_string instanceStr = Marshaling.ConvertStringToNative(instance);
            NativeFuncs.kosmicsharp_string_to_pascal_case(instanceStr, out kosmic_string pascalCase);
            using (pascalCase)
        ...
        {
            using kosmic_string instanceStr = Marshaling.ConvertStringToNative(instance);
            NativeFuncs.kosmicsharp_string_to_snake_case(instanceStr, out kosmic_string snakeCase);
            using (snakeCase)
...
#pragma warning restore CA1309
        ...
        /// <example>
        /// <code>
        /// KS.Print("/path/to/file.txt".GetExtension())  // "txt"
        /// KS.Print("file.txt".GetExtension())  // "txt"
        /// KS.Print("file.sample.txt".GetExtension())  // "txt"
        /// KS.Print(".txt".GetExtension())  // "txt"
        /// KS.Print("file.txt.".GetExtension())  // "" (empty string)
        /// KS.Print("file.txt..".GetExtension())  // "" (empty string)
        /// KS.Print("txt".GetExtension())  // "" (empty string)
        /// KS.Print("".GetExtension())  // "" (empty string)
        /// </code>
        /// </example>
        ...
        /// <example>
        /// <code>
        /// KS.Print("1.7".IsValidFloat())  // Prints "True"
        /// KS.Print("24".IsValidFloat())  // Prints "True"
        /// KS.Print("7e3".IsValidFloat())  // Prints "True"
        /// KS.Print("Hello".IsValidFloat())  // Prints "False"
        /// </code>
        /// </example>
        /// <param name="instance">The string to check.</param>
        ...
        /// <example>
        /// <code>
        /// KS.Print("good_ident_1".IsValidIdentifier())  // Prints "True"
        /// KS.Print("1st_bad_ident".IsValidIdentifier())  // Prints "False"
        /// KS.Print("bad_ident_#2".IsValidIdentifier())  // Prints "False"
        /// </code>
        /// </example>
        /// <param name="instance">The string to check.</param>
        ...
        /// <example>
        /// <code>
        /// KS.Print("7".IsValidInt())  // Prints "True"
        /// KS.Print("14.6".IsValidInt())  // Prints "False"
        /// KS.Print("L".IsValidInt())  // Prints "False"
        /// KS.Print("+3".IsValidInt())  // Prints "True"
        /// KS.Print("-12".IsValidInt())  // Prints "True"
        /// </code>
        /// </example>
        /// <param name="instance">The string to check.</param>
...
#pragma warning restore CA5350
        ...
        {
            using kosmic_string instanceStr = Marshaling.ConvertStringToNative(instance);
            NativeFuncs.kosmicsharp_string_simplify_path(instanceStr, out kosmic_string simplifiedPath);
