...
namespace Kosmic
{
    ...
    public static partial class KS
    {
        ...
        public static Variant BytesToVar(Span<byte> bytes)
        {
            ...
            NativeFuncs.kosmicsharp_bytes_to_var(varBytes, kosmic_bool.False, out kosmic_variant ret);
        ...
        {
            using var varBytes = Marshaling.ConvertSystemArrayToNativePackedByteArray(bytes);
            NativeFuncs.kosmicsharp_bytes_to_var(varBytes, kosmic_bool.True, out kosmic_variant ret);
            return Variant.CreateTakingOwnershipOfDisposableValue(ret);
        }
        ...
        /// <example>
        /// <code>
        /// Variant a = new Kosmic.Collections.Array { 4, 2.5, 1.2 };
        /// KS.Print(a.VariantType == Variant.Type.Array); // Prints true
        ///
        /// var b = KS.Convert(a, Variant.Type.PackedByteArray);
        /// KS.Print(b); // Prints [4, 2, 1]
        /// KS.Print(b.VariantType == Variant.Type.Array); // Prints false
        /// </code>
        /// </example>
        ...
        {
            NativeFuncs.kosmicsharp_convert((kosmic_variant)what.NativeVar, (int)type, out kosmic_variant ret);
            return Variant.CreateTakingOwnershipOfDisposableValue(ret);
        }
        ...
        /// <example>
        /// <code>
        /// KS.Print(KS.Hash("a")); // Prints 177670
        /// </code>
        /// </example>
        ...
        {
            return NativeFuncs.kosmicsharp_hash((kosmic_variant)var.NativeVar);
        }
        ...
        /// var main = KS.Load("res://main.tscn"); // main will contain a PackedScene resource.
        /// </code>
        /// </example>
        ...
        /// <code>
        /// // Load a scene called main located in the root of the project directory and cache it in a variable.
        /// var main = KS.Load&lt;PackedScene&gt;("res://main.tscn"); // main will contain a PackedScene resource.
        /// </code>
        /// </example>
        /// <param name="path">Path of the <see cref="Resource"/> to load.</param>
        ...
        /// <example>
        /// <code>
        /// var a = new Kosmic.Collections.Array { 1, 2, 3 };
        /// KS.Print("a", "b", a); // Prints ab[1, 2, 3]
        /// </code>
        /// </example>
        ...
        /// <example>
        /// <code>
        /// KS.PrintRich("[code][b]Hello world![/b][/code]"); // Prints out: [b]Hello world![/b]
        /// </code>
        /// </example>
        /// <param name="what">Arguments that will be printed.</param>
        ...
        [StackTraceHidden]
        private static void ErrPrintError(string message, kosmic_error_handler_type type = kosmic_error_handler_type.ERR_HANDLER_ERROR)
        {
            ...
            using kosmic_string messageStr = Marshaling.ConvertStringToNative(message);
            using kosmic_string callerNameStr = Marshaling.ConvertStringToNative(callerName);
            using kosmic_string callerFilePathStr = Marshaling.ConvertStringToNative(callerFilePath);
            NativeFuncs.kosmicsharp_err_print_error(callerNameStr, callerFilePathStr, callerLineNumber, messageStr, p_type: type);
        }
        ...
        /// <example>
        /// <code>
        /// KS.PushError("test error"); // Prints "test error" to debugger and terminal as error call
        /// </code>
        /// </example>
        ...
        /// <example>
        /// <code>
        /// KS.PushError("test_error"); // Prints "test error" to debugger and terminal as error call
        /// </code>
        /// </example>
        ...
        /// <example>
        /// <code>
        /// KS.PushWarning("test warning"); // Prints "test warning" to debugger and terminal as warning call
        /// </code>
        /// </example>
        /// <param name="message">Warning message.</param>
        public static void PushWarning(string message)
        {
            ErrPrintError(message, type: kosmic_error_handler_type.ERR_HANDLER_WARNING);
        }
        ...
        {
            ErrPrintError(AppendPrintParams(what), type: kosmic_error_handler_type.ERR_HANDLER_WARNING);
        }
        ...
        /// <example>
        /// <code>
        /// KS.Randf(); // Returns e.g. 0.375671
        /// </code>
        /// </example>
        /// <returns>A random <see langword="float"/> number.</returns>
        public static float Randf()
        {
            return NativeFuncs.kosmicsharp_randf();
        }
        ...
        {
            return NativeFuncs.kosmicsharp_randfn(mean, deviation);
        }
        ...
        /// <example>
        /// <code>
        /// KS.Randi();           // Returns random integer between 0 and 2^32 - 1
        /// KS.Randi() % 20;      // Returns random integer between 0 and 19
        /// KS.Randi() % 100;     // Returns random integer between 0 and 99
        /// KS.Randi() % 100 + 1; // Returns random integer between 1 and 100
        /// </code>
        /// </example>
        /// <returns>A random <see langword="uint"/> number.</returns>
        public static uint Randi()
        {
            return NativeFuncs.kosmicsharp_randi();
        }
        ...
        {
            NativeFuncs.kosmicsharp_randomize();
        }
        ...
        /// <example>
        /// <code>
        /// KS.RandRange(0.0, 20.5);   // Returns e.g. 7.45315
        /// KS.RandRange(-10.0, 10.0); // Returns e.g. -3.844535
        /// </code>
        /// </example>
        /// <returns>A random <see langword="double"/> number inside the given range.</returns>
        public static double RandRange(double from, double to)
        {
            return NativeFuncs.kosmicsharp_randf_range(from, to);
        }
        ...
        /// <example>
        /// <code>
        /// KS.RandRange(0, 1);      // Returns either 0 or 1
        /// KS.RandRange(-10, 1000); // Returns random integer between -10 and 1000
        /// </code>
        /// </example>
        /// <returns>A random <see langword="int"/> number inside the given range.</returns>
        public static int RandRange(int from, int to)
        {
            return NativeFuncs.kosmicsharp_randi_range(from, to);
        }
        ...
        {
            return NativeFuncs.kosmicsharp_rand_from_seed(seed, out seed);
        }
        ...
        /// <example>
        /// <code>
        /// ulong mySeed = (ulong)KS.Hash("Godot Rocks");
        /// KS.Seed(mySeed);
        /// var a = KS.Randf() + KS.Randi();
        /// KS.Seed(mySeed);
        /// var b = KS.Randf() + KS.Randi();
        ...
        {
            NativeFuncs.kosmicsharp_seed(seed);
        }
        ...
        /// var b = KS.StrToVar(a).AsKosmicDictionary(); // b is a Dictionary
        /// KS.Print(b["a"]);                           // Prints 1
        /// </code>
        /// </example>
        ...
        {
            NativeFuncs.kosmicsharp_var_to_bytes((kosmic_variant)var.NativeVar, kosmic_bool.False, out var varBytes);
            using (varBytes)
        ...
        {
            NativeFuncs.kosmicsharp_var_to_bytes((kosmic_variant)var.NativeVar, kosmic_bool.True, out var varBytes);
            using (varBytes)
                return Marshaling.ConvertNativePackedByteArrayToSystemArray(varBytes);
        }
        ...
        /// <example>
        /// <code>
        /// var a = new Kosmic.Collections.Dictionary { ["a"] = 1, ["b"] = 2 };
        /// KS.Print(KS.VarToStr(a));
        /// // Prints:
        /// // {
        /// //     "a": 1,
        /// //     "b": 2
        ...
        {
            NativeFuncs.kosmicsharp_var_to_str((kosmic_variant)var.NativeVar, out kosmic_string ret);
            using (ret)
