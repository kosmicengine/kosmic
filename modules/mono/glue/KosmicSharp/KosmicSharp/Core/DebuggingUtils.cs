...
#pragma warning disable IDE1006 // Naming rule violation
        ...
        internal ref struct kosmic_stack_info
        {
            public kosmic_string File;
            public kosmic_string Func;
            public int Line;
        }

        // ReSharper disable once InconsistentNaming
        [StructLayout(LayoutKind.Sequential)]
        internal ref struct kosmic_stack_info_vector
        {
            private IntPtr _writeProxy;
            private unsafe kosmic_stack_info* _ptr;

            public readonly unsafe kosmic_stack_info* Elements
            {
            ...
            public void Resize(int size)
            {
                ...
                var err = NativeFuncs.kosmicsharp_stack_info_vector_resize(ref this, size);
                if (err != Error.Ok)
            ...
            public unsafe void Dispose()
            {
                if (_ptr == null)
                    return;
                NativeFuncs.kosmicsharp_stack_info_vector_destroy(ref this);
                _ptr = null;
            }
        }
#pragma warning restore IDE1006
        ...
        internal static unsafe void GetCurrentStackInfo(void* destVector)
        {
            try
            {
                var vector = (kosmic_stack_info_vector*)destVector;
                ...
                foreach (StackFrame frame in stackTrace.GetFrames())
                {
                    ...
                    kosmic_stack_info* stackInfo = &vector->Elements[i];
