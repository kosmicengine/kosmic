...
namespace Kosmic.Collections
{
    ...
    public sealed class Dictionary :
        ...
        IDisposable
    {
        internal kosmic_dictionary.movable NativeValue;
        ...
        public Dictionary()
        {
            NativeValue = (kosmic_dictionary.movable)NativeFuncs.kosmicsharp_dictionary_new();
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        private Dictionary(kosmic_dictionary nativeValueToOwn)
        {
            NativeValue = (kosmic_dictionary.movable)(nativeValueToOwn.IsAllocated ?
                nativeValueToOwn :
                NativeFuncs.kosmicsharp_dictionary_new());
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        // Explicit name to make it very clear
        internal static Dictionary CreateTakingOwnershipOfDisposableValue(kosmic_dictionary nativeValueToOwn)
        ...
        /// referenced in the source dictionary. Note that any <see cref="KosmicObject"/> derived
        ...
        {
            var self = (kosmic_dictionary)NativeValue;
            var otherVariant = (kosmic_dictionary)other.NativeValue;
            return NativeFuncs.kosmicsharp_dictionary_recursive_equal(ref self, otherVariant).ToBool();
        }
        ...
        public ICollection<Variant> Keys
        {
            get
            {
                kosmic_array keysArray;
                var self = (kosmic_dictionary)NativeValue;
                NativeFuncs.kosmicsharp_dictionary_keys(ref self, out keysArray);
        ...
        public ICollection<Variant> Values
        {
            get
            {
                kosmic_array valuesArray;
                var self = (kosmic_dictionary)NativeValue;
                NativeFuncs.kosmicsharp_dictionary_values(ref self, out valuesArray);
        ...
        private (Array keys, Array values, int count) GetKeyValuePairs()
        {
            ...
            int count = NativeFuncs.kosmicsharp_dictionary_count(ref self);
        ...
        public Variant this[Variant key]
        {
            get
            {
                ...
                if (NativeFuncs.kosmicsharp_dictionary_try_get_value(ref self,
                        (kosmic_variant)key.NativeVar, out kosmic_variant value).ToBool())
                {
            ...
            set
            {
                ...
                var self = (kosmic_dictionary)NativeValue;
                NativeFuncs.kosmicsharp_dictionary_set_value(ref self,
                    (kosmic_variant)key.NativeVar, (kosmic_variant)value.NativeVar);
            }
        }
        ...
        public void Add(Variant key, Variant value)
        {
            ...
            var variantKey = (kosmic_variant)key.NativeVar;
            var self = (kosmic_dictionary)NativeValue;

            if (NativeFuncs.kosmicsharp_dictionary_contains_key(ref self, variantKey).ToBool())
                throw new ArgumentException("An element with the same key already exists.", nameof(key));

            kosmic_variant variantValue = (kosmic_variant)value.NativeVar;
            NativeFuncs.kosmicsharp_dictionary_add(ref self, variantKey, variantValue);
        }
        ...
        public void Clear()
        {
            ...
            var self = (kosmic_dictionary)NativeValue;
            NativeFuncs.kosmicsharp_dictionary_clear(ref self);
        }
        ...
        {
            var self = (kosmic_dictionary)NativeValue;
            return NativeFuncs.kosmicsharp_dictionary_contains_key(ref self, (kosmic_variant)key.NativeVar).ToBool();
        }

        bool ICollection<KeyValuePair<Variant, Variant>>.Contains(KeyValuePair<Variant, Variant> item)
        {
            kosmic_variant variantKey = (kosmic_variant)item.Key.NativeVar;
            var self = (kosmic_dictionary)NativeValue;
            bool found = NativeFuncs.kosmicsharp_dictionary_try_get_value(ref self,
                variantKey, out kosmic_variant retValue).ToBool();
            ...
            using (retValue)
            {
                ...
                kosmic_variant variantValue = (kosmic_variant)item.Value.NativeVar;
                return NativeFuncs.kosmicsharp_variant_equals(variantValue, retValue).ToBool();
            }
        }
        ...
        public bool Remove(Variant key)
        {
            ...
            var self = (kosmic_dictionary)NativeValue;
            return NativeFuncs.kosmicsharp_dictionary_remove_key(ref self, (kosmic_variant)key.NativeVar).ToBool();
        }
        ...
        bool ICollection<KeyValuePair<Variant, Variant>>.Remove(KeyValuePair<Variant, Variant> item)
        {
            ...
            using (retValue)
            {
                ...
                kosmic_variant variantValue = (kosmic_variant)item.Value.NativeVar;
                if (NativeFuncs.kosmicsharp_variant_equals(variantValue, retValue).ToBool())
                {
                    return NativeFuncs.kosmicsharp_dictionary_remove_key(
        ...
        public int Count
        {
            ...
            {
                var self = (kosmic_dictionary)NativeValue;
                return NativeFuncs.kosmicsharp_dictionary_count(ref self);
            }
        }
        ...
        public void MakeReadOnly()
        {
            ...
            var self = (kosmic_dictionary)NativeValue;
            NativeFuncs.kosmicsharp_dictionary_make_read_only(ref self);
        }
        ...
        public bool TryGetValue(Variant key, out Variant value)
        {
            var self = (kosmic_dictionary)NativeValue;
            bool found = NativeFuncs.kosmicsharp_dictionary_try_get_value(ref self,
                (kosmic_variant)key.NativeVar, out kosmic_variant retValue).ToBool();
        ...
        {
            var self = (kosmic_dictionary)NativeValue;
            NativeFuncs.kosmicsharp_dictionary_key_value_pair_at(ref self, index,
                out kosmic_variant key,
                out kosmic_variant value);
        ...
        {
            var self = (kosmic_dictionary)NativeValue;
            NativeFuncs.kosmicsharp_dictionary_to_string(ref self, out kosmic_string str);
            using (str)
    ...
    internal interface IGenericKosmicDictionary
    {
        ...
        IGenericKosmicDictionary
    {
        ...
        private void SetTypedForUnderlyingDictionary()
        {
            ...
            {
                NativeFuncs.kosmicsharp_dictionary_set_typed(
                    ref self,
                    (uint)keyVariantType,
                    keyClassName,
                    keyScriptRef,
        ...
        Dictionary IGenericKosmicDictionary.UnderlyingDictionary => _underlyingDict;

        internal ref kosmic_dictionary.movable NativeValue
        {
        ...
        internal static Dictionary<TKey, TValue> CreateTakingOwnershipOfDisposableValue(
            kosmic_dictionary nativeValueToOwn)
        ...
        public TValue this[TKey key]
        {
            get
            {
                ...
                var self = (kosmic_dictionary)_underlyingDict.NativeValue;

                if (NativeFuncs.kosmicsharp_dictionary_try_get_value(ref self,
                        variantKey, out kosmic_variant value).ToBool())
                {
                    using (value)
        ...
        public ICollection<TKey> Keys
        {
            get
            {
                kosmic_array keyArray;
                var self = (kosmic_dictionary)_underlyingDict.NativeValue;
                NativeFuncs.kosmicsharp_dictionary_keys(ref self, out keyArray);
        ...
        public bool ContainsKey(TKey key)
        {
            using var variantKey = VariantUtils.CreateFrom(key);
            var self = (kosmic_dictionary)_underlyingDict.NativeValue;
            return NativeFuncs.kosmicsharp_dictionary_contains_key(ref self, variantKey).ToBool();
        }
        ...
        public bool Remove(TKey key)
        {
            ...
            using var variantKey = VariantUtils.CreateFrom(key);
            var self = (kosmic_dictionary)_underlyingDict.NativeValue;
            return NativeFuncs.kosmicsharp_dictionary_remove_key(ref self, variantKey).ToBool();
        }
        ...
        public static explicit operator Dictionary<TKey, TValue>(Variant from) =>
            from.AsKosmicDictionary<TKey, TValue>();
