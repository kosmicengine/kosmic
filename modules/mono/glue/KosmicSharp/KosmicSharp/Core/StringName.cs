...
namespace Kosmic
{
    ...
    {
        internal kosmic_string_name.movable NativeValue;
        ...
        private StringName(kosmic_string_name nativeValueToOwn)
        {
            NativeValue = (kosmic_string_name.movable)nativeValueToOwn;
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        // Explicit name to make it very clear
        internal static StringName CreateTakingOwnershipOfDisposableValue(kosmic_string_name nativeValueToOwn)
        ...
        public StringName(string name)
        {
            ...
            {
                NativeValue = (kosmic_string_name.movable)NativeFuncs.kosmicsharp_string_name_new_from_string(name);
                _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
            }
        }
        ...
        public override string ToString()
        {
            ...
            var src = (kosmic_string_name)NativeValue;
            NativeFuncs.kosmicsharp_string_name_as_string(out kosmic_string dest, src);
            using (dest)
        ...
        public static bool operator ==(StringName? left, in kosmic_string_name right)
        {
            if (left is null)
        ...
        public static bool operator ==(in kosmic_string_name left, StringName? right)
        {
            return right == left;
        }
        ...
        public bool Equals(in kosmic_string_name other)
        {
