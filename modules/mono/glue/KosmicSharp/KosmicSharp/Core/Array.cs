...
#pragma warning restore CA1710
        ...
        IDisposable
    {
        internal kosmic_array.movable NativeValue;
        ...
        public Array()
        {
            NativeValue = (kosmic_array.movable)NativeFuncs.kosmicsharp_array_new();
        ...
        private Array(kosmic_array nativeValueToOwn)
        {
            NativeValue = (kosmic_array.movable)(nativeValueToOwn.IsAllocated ?
                nativeValueToOwn :
                NativeFuncs.kosmicsharp_array_new());
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        // Explicit name to make it very clear
        internal static Array CreateTakingOwnershipOfDisposableValue(kosmic_array nativeValueToOwn)
        ...
        /// referenced in the source array. Note that any <see cref="KosmicObject"/> derived
        ...
        /// Note: If <paramref name="value"/> is of a reference type (<see cref="KosmicObject"/>
        ...
        /// <example>
        /// <code>
        /// var array = new Kosmic.Collections.Array();
        /// array.Resize(10);
        ...
        public void Fill(Variant value)
        {
            ...
            kosmic_variant variantValue = (kosmic_variant)value.NativeVar;
            var self = (kosmic_array)NativeValue;
            NativeFuncs.kosmicsharp_array_fill(ref self, variantValue);
        }
        ...
        public Variant Max()
        {
            kosmic_variant resVariant;
            var self = (kosmic_array)NativeValue;
            NativeFuncs.kosmicsharp_array_max(ref self, out resVariant);
        ...
        public Variant Min()
        {
            kosmic_variant resVariant;
            var self = (kosmic_array)NativeValue;
            NativeFuncs.kosmicsharp_array_min(ref self, out resVariant);
            return Variant.CreateTakingOwnershipOfDisposableValue(resVariant);
        }
        ...
        /// <example>
        /// <code>
        /// var array = new Kosmic.Collections.Array { 1, 2, 3, 4 };
        /// KS.Print(array.PickRandom()); // Prints either of the four numbers.
        /// </code>
        /// </example>
        ...
        public Variant PickRandom()
        {
            kosmic_variant resVariant;
            var self = (kosmic_array)NativeValue;
            NativeFuncs.kosmicsharp_array_pick_random(ref self, out resVariant);
            return Variant.CreateTakingOwnershipOfDisposableValue(resVariant);
        }
        ...
        {
            var self = (kosmic_array)NativeValue;
            var otherVariant = (kosmic_array)other.NativeValue;
            return NativeFuncs.kosmicsharp_array_recursive_equal(ref self, otherVariant).ToBool();
        }
        ...
        public Error Resize(int newSize)
        {
            ...
            var self = (kosmic_array)NativeValue;
            return NativeFuncs.kosmicsharp_array_resize(ref self, newSize);
        }
        ...
        public void Reverse()
        {
            ...
            var self = (kosmic_array)NativeValue;
            NativeFuncs.kosmicsharp_array_reverse(ref self);
        }
        ...
        /// such as <see cref="KS.Randi"/>. Call <see cref="KS.Randomize"/> to
        ...
        public void Shuffle()
        {
            ...
            var self = (kosmic_array)NativeValue;
            NativeFuncs.kosmicsharp_array_shuffle(ref self);
        }
        ...
        /// <example>
        /// <code>
        /// var strings = new Kosmic.Collections.Array { "string1", "string2", "string10", "string11" };
        /// strings.Sort();
        /// KS.Print(strings); // Prints [string1, string10, string11, string2]
        /// </code>
        /// </example>
        /// <exception cref="InvalidOperationException">
        /// The array is read-only.
        ...
        public void Sort()
        {
            ...
            var self = (kosmic_array)NativeValue;
            NativeFuncs.kosmicsharp_array_sort(ref self);
        }
        ...
        public unsafe Variant this[int index]
        {
            get
            {
                GetVariantBorrowElementAt(index, out kosmic_variant borrowElem);
            ...
            set
            {
                ...
                var self = (kosmic_array)NativeValue;
                kosmic_variant* ptrw = NativeFuncs.kosmicsharp_array_ptrw(ref self);
                kosmic_variant* itemPtr = &ptrw[index];
                (*itemPtr).Dispose();
        ...
        /// This is the same as <c>append</c> or <c>push_back</c> in VoyScript.
        /// </summary>
        /// <exception cref="InvalidOperationException">
        /// The array is read-only.
        /// </exception>
        ...
        public void Add(Variant item)
        {
            ...
            kosmic_variant variantValue = (kosmic_variant)item.NativeVar;
            var self = (kosmic_array)NativeValue;
            _ = NativeFuncs.kosmicsharp_array_add(ref self, variantValue);
        }
        ...
        public void AddRange<[MustBeVariant] T>(IEnumerable<T> collection)
        {
            ...
            {
                var self = (kosmic_array)NativeValue;
                var collectionNative = (kosmic_array)array.NativeValue;
                _ = NativeFuncs.kosmicsharp_array_add_range(ref self, collectionNative);
                return;
            }
            if (collection is Array<T> typedArray)
            {
                var self = (kosmic_array)NativeValue;
                var collectionNative = (kosmic_array)typedArray.NativeValue;
                _ = NativeFuncs.kosmicsharp_array_add_range(ref self, collectionNative);
                return;
            }
        ...
        public int BinarySearch(int index, int count, Variant item)
        {
            ...
            kosmic_variant variantValue = (kosmic_variant)item.NativeVar;
            var self = (kosmic_array)NativeValue;
            return NativeFuncs.kosmicsharp_array_binary_search(ref self, index, count, variantValue);
        }
        ...
        /// <example>
        /// <code>
        /// var arr = new Kosmic.Collections.Array { "inside", 7 };
        /// KS.Print(arr.Contains("inside")); // True
        /// KS.Print(arr.Contains("outside")); // False
        /// KS.Print(arr.Contains(7)); // True
        /// KS.Print(arr.Contains("7")); // False
        /// </code>
        /// </example>
        ...
        public int IndexOf(Variant item)
        {
            ...
            kosmic_variant variantValue = (kosmic_variant)item.NativeVar;
            var self = (kosmic_array)NativeValue;
            return NativeFuncs.kosmicsharp_array_index_of(ref self, variantValue);
        }
        ...
        public int IndexOf(Variant item, int index)
        {
            ...
            kosmic_variant variantValue = (kosmic_variant)item.NativeVar;
            var self = (kosmic_array)NativeValue;
            return NativeFuncs.kosmicsharp_array_index_of(ref self, variantValue, index);
        }
        ...
        public int LastIndexOf(Variant item)
        {
            ...
            kosmic_variant variantValue = (kosmic_variant)item.NativeVar;
            var self = (kosmic_array)NativeValue;
            return NativeFuncs.kosmicsharp_array_last_index_of(ref self, variantValue, Count - 1);
        }
        ...
        public int LastIndexOf(Variant item, int index)
        {
            ...
            kosmic_variant variantValue = (kosmic_variant)item.NativeVar;
            var self = (kosmic_array)NativeValue;
            return NativeFuncs.kosmicsharp_array_last_index_of(ref self, variantValue, index);
        }
        ...
        public void Insert(int index, Variant item)
        {
            ...
            kosmic_variant variantValue = (kosmic_variant)item.NativeVar;
            var self = (kosmic_array)NativeValue;
            NativeFuncs.kosmicsharp_array_insert(ref self, index, variantValue);
        }
        ...
        public void RemoveAt(int index)
        {
            ...
            var self = (kosmic_array)NativeValue;
            NativeFuncs.kosmicsharp_array_remove_at(ref self, index);
        }
        ...
        public void MakeReadOnly()
        {
            ...
            var self = (kosmic_array)NativeValue;
            NativeFuncs.kosmicsharp_array_make_read_only(ref self);
        }
        ...
        {
            var self = (kosmic_array)NativeValue;
            NativeFuncs.kosmicsharp_array_to_string(ref self, out kosmic_string str);
            using (str)
        ...
        /// <paramref name="index"/> is less than 0 or greater than the array's size.
        /// </exception>
        internal void GetVariantBorrowElementAt(int index, out kosmic_variant elem)
        {
            if (index < 0 || index >= Count)
                throw new ArgumentOutOfRangeException(nameof(index));
        ...
        /// The variant returned via the <paramref name="elem"/> parameter is owned by the Array and must not be disposed.
        /// </summary>
        internal unsafe void GetVariantBorrowElementAtUnchecked(int index, out kosmic_variant elem)
        {
        ...
        IGenericGodotArray
    {
        ...
        private void SetTypedForUnderlyingArray()
        {
            ...
            using (elemScriptRef)
            {
                NativeFuncs.kosmicsharp_array_set_typed(
                    ref self,
        ...
        // Explicit name to make it very clear
        internal static Array<T> CreateTakingOwnershipOfDisposableValue(kosmic_array nativeValueToOwn)
        ...
        /// <example>
        /// <code>
        /// var array = new Kosmic.Collections.Array&lt;int&gt;();
        /// array.Resize(10);
        /// array.Fill(0); // Initialize the 10 elements to 0.
        /// </code>
        /// </example>
        ...
        public void Fill(T value)
        {
            ...
            kosmic_variant variantValue = VariantUtils.CreateFrom(value);
            var self = (kosmic_array)_underlyingArray.NativeValue;
            NativeFuncs.kosmicsharp_array_fill(ref self, variantValue);
        }
        ...
        /// <example>
        /// <code>
        /// var array = new Kosmic.Collections.Array&lt;int&gt; { 1, 2, 3, 4 };
        /// KS.Print(array.PickRandom()); // Prints either of the four numbers.
        /// </code>
        /// </example>
        /// <returns>A random element from the array.</returns>
        ...
        /// <example>
        /// <code>
        /// var strings = new Kosmic.Collections.Array&lt;string&gt; { "string1", "string2", "string10", "string11" };
        /// strings.Sort();
        /// KS.Print(strings); // Prints [string1, string10, string11, string2]
        /// </code>
        /// </example>
        ...
        public unsafe T this[int index]
        {
            get
            {
                _underlyingArray.GetVariantBorrowElementAt(index, out kosmic_variant borrowElem);
        ...
        public int IndexOf(T item, int index)
        {
            ...
            kosmic_variant variantValue = VariantUtils.CreateFrom(item);
            var self = (kosmic_array)_underlyingArray.NativeValue;
            return NativeFuncs.kosmicsharp_array_index_of(ref self, variantValue, index);
        }
        ...
        public void AddRange(IEnumerable<T> collection)
        {
            ...
            {
                var self = (kosmic_array)_underlyingArray.NativeValue;
                var collectionNative = (kosmic_array)typedArray._underlyingArray.NativeValue;
                _ = NativeFuncs.kosmicsharp_array_add_range(ref self, collectionNative);
                return;
            }
        ...
        /// <example>
        /// <code>
        /// var arr = new Kosmic.Collections.Array&lt;string&gt; { "inside", "7" };
        /// KS.Print(arr.Contains("inside")); // True
        /// KS.Print(arr.Contains("outside")); // False
        /// KS.Print(arr.Contains(7)); // False
        /// KS.Print(arr.Contains("7")); // True
