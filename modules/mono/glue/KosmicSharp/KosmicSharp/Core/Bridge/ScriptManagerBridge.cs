    ...
    public static partial class ScriptManagerBridge
    {
            ...
            kosmic_variant** args, int argCount)
        {
            ...
            try
            {
                ...
                var obj = (KosmicObject)RuntimeHelpers.GetUninitializedObject(scriptType);
        ...
        [UnmanagedCallersOnly]
        internal static unsafe void GetScriptNativeName(IntPtr scriptPtr, kosmic_string_name* outRes)
        {
            try
            {
                // Performance is not critical here as this will be replaced with source generators.
                ...
                var nativeName = KosmicObject.InternalGetClassNativeBaseName(scriptType);
                ...
                *outRes = NativeFuncs.kosmicsharp_string_name_new_copy((kosmic_string_name)nativeName.NativeValue);
            }
            catch (Exception e)
            {
                ExceptionUtils.LogException(e);
        ...
        [UnmanagedCallersOnly]
        internal static unsafe void GetGlobalClassName(kosmic_string* scriptPath, kosmic_string* outBaseType, kosmic_string* outIconPath, kosmic_string* outClassName)
        {
            ...
            if (outBaseType != null)
            {
                ...
                Type native = KosmicObject.InternalGetClassNativeBase(scriptType);
        ...
        [UnmanagedCallersOnly]
        internal static void SetKosmicObjectPtr(IntPtr gcHandlePtr, IntPtr newPtr)
        {
            try
            {
                var target = (KosmicObject?)GCHandle.FromIntPtr(gcHandlePtr).Target;
                if (target != null)
        ...
        public static void LookupScriptsInAssembly(Assembly assembly)
        {
            ...
            if (assemblyHasScriptsAttr.RequiresLookup)
            {
                ...
                var typeOfKosmicObject = typeof(KosmicObject);
                ...
                foreach (var type in assembly.GetTypes())
                {
                    ...
                    if (!typeOfKosmicObject.IsAssignableFrom(type))
                        continue;
            ...
            if (NativeFuncs.kosmicsharp_dotnet_module_is_initialized().ToBool() && Engine.IsEditorHint())
            {
                if (_pathTypeBiMap.Paths.Count > 0)
                {
                    string[] scriptPaths = _pathTypeBiMap.Paths.ToArray();
                    using kosmic_packed_string_array scriptPathsNative = Marshaling.ConvertSystemArrayToNativePackedStringArray(scriptPaths);
                    NativeFuncs.kosmicsharp_internal_editor_file_system_update_files(scriptPathsNative);
                }
            }
        }
        ...
        internal static unsafe void RaiseEventSignal(IntPtr ownerGCHandlePtr,
            kosmic_string_name* eventSignalName, kosmic_variant** args, int argCount, kosmic_bool* outOwnerIsNull)
        {
            try
            {
                var owner = (KosmicObject?)GCHandle.FromIntPtr(ownerGCHandlePtr).Target;

                if (owner == null)
                {
                    *outOwnerIsNull = kosmic_bool.True;
                    return;
                }

                *outOwnerIsNull = kosmic_bool.False;

                owner.RaiseKosmicClassSignalCallbacks(CustomUnsafe.AsRef(eventSignalName),
        ...
        [UnmanagedCallersOnly]
        internal static kosmic_bool ScriptIsOrInherits(IntPtr scriptPtr, IntPtr scriptPtrMaybeBase)
        {
            try
            {
                if (!_scriptTypeBiMap.TryGetScriptType(scriptPtr, out Type? scriptType))
        ...
        [UnmanagedCallersOnly]
        internal static unsafe kosmic_bool AddScriptBridge(IntPtr scriptPtr, kosmic_string* scriptPath)
        {
            try
            {
                string scriptPathStr = Marshaling.ConvertStringToManaged(*scriptPath);
        ...
        [UnmanagedCallersOnly]
        internal static unsafe void GetOrCreateScriptBridgeForPath(kosmic_string* scriptPath, kosmic_ref* outScript)
        {
            string scriptPathStr = Marshaling.ConvertStringToManaged(*scriptPath);

            if (!_pathTypeBiMap.TryGetScriptType(scriptPathStr, out Type? scriptType))
            {
                NativeFuncs.kosmicsharp_internal_new_csharp_script(outScript);
                return;
            }
        ...
        private static unsafe void GetOrCreateScriptBridgeForType(Type scriptType, kosmic_ref* outScript)
        {
            _scriptTypeBiMap.ReadWriteLock.EnterUpgradeableReadLock();
            try
            {
                ...
                {
                    // Use existing
                    NativeFuncs.kosmicsharp_ref_new_from_ref_counted_ptr(out *outScript, scriptPtr);
                    return;
                }
        ...
        internal static unsafe void GetOrLoadOrCreateScriptForType(Type scriptType, kosmic_ref* outScript)
        {
            static bool GetPathOtherwiseGetOrCreateScript(Type scriptType, kosmic_ref* outScript,
            ...
            if (GetPathOtherwiseGetOrCreateScript(scriptType, outScript, out string? scriptPath))
            {
                ...
                using kosmic_string scriptPathIn = Marshaling.ConvertStringToNative(scriptPath);
                if (!NativeFuncs.kosmicsharp_internal_script_load(scriptPathIn, outScript).ToBool())
                {
                    KS.PushError($"Cannot load script for type '{scriptType.FullName}'. Path: '{scriptPath}'.");
        ...
        private static unsafe void CreateScriptBridgeForType(Type scriptType, kosmic_ref* outScript)
        {
            ...
            NativeFuncs.kosmicsharp_internal_reload_registered_script(outScript->Reference);
        }
        ...
        [UnmanagedCallersOnly]
        internal static kosmic_bool TryReloadRegisteredScriptWithClass(IntPtr scriptPtr)
        {
            _scriptTypeBiMap.ReadWriteLock.EnterUpgradeableReadLock();
            try
            {
                if (_scriptTypeBiMap.TryGetScriptType(scriptPtr, out _))
                {
                    ...
                    NativeFuncs.kosmicsharp_internal_reload_registered_script(scriptPtr);
                    return kosmic_bool.True;
                }

                if (!_scriptDataForReload.TryGetValue(scriptPtr, out var dataForReload))
                {
                    KS.PushError("Missing class qualified name for reloading script");
                    return kosmic_bool.False;
                }
                ...
                if (!typeof(KosmicObject).IsAssignableFrom(scriptType))
                {
                    // The class no longer inherits KosmicObject, can't reload
                    return kosmic_bool.False;
                }
        ...
        private static unsafe void GetScriptTypeInfo(Type scriptType, kosmic_csharp_type_info* outTypeInfo)
        {
            kosmic_string className = Marshaling.ConvertStringToNative(ReflectionUtils.ConstructTypeName(scriptType));

            StringName? nativeBase = KosmicObject.InternalGetClassNativeBaseName(scriptType);

            kosmic_string_name nativeBaseName = nativeBase != null
                ? NativeFuncs.kosmicsharp_string_name_new_copy((kosmic_string_name)nativeBase.NativeValue)
                : default;
            ...
            kosmic_string iconPath = Marshaling.ConvertStringToNative(iconAttr?.Path);
        ...
        [UnmanagedCallersOnly]
        internal static unsafe void UpdateScriptClassInfo(IntPtr scriptPtr, kosmic_csharp_type_info* outTypeInfo,
            kosmic_array* outMethodsDest, kosmic_dictionary* outRpcFunctionsDest, kosmic_dictionary* outEventSignalsDest, kosmic_ref* outBaseScript)
        {
            try
            {
                // Performance is not critical here as this will be replaced with source generators.
                ...
                *outMethodsDest = NativeFuncs.kosmicsharp_array_new_copy(
                    (kosmic_array)methods.NativeValue);
                ...
                *outRpcFunctionsDest = NativeFuncs.kosmicsharp_dictionary_new_copy(
                    (kosmic_dictionary)rpcFunctions.NativeValue);
                ...
                *outEventSignalsDest = NativeFuncs.kosmicsharp_dictionary_new_copy(
                    (kosmic_dictionary)signals.NativeValue);
            ...
            catch (Exception e)
            {
                ExceptionUtils.LogException(e);
                *outTypeInfo = default;
                *outMethodsDest = NativeFuncs.kosmicsharp_array_new();
                *outRpcFunctionsDest = NativeFuncs.kosmicsharp_dictionary_new();
                *outEventSignalsDest = NativeFuncs.kosmicsharp_dictionary_new();
                *outBaseScript = default;
            }
        }
        ...
        {
            var getKosmicSignalListMethod = type.GetMethod(
                "GetKosmicSignalList",
                BindingFlags.DeclaredOnly | BindingFlags.Static |
                BindingFlags.NonPublic | BindingFlags.Public);

            if (getKosmicSignalListMethod == null)
                return null;

            return (List<MethodInfo>?)getKosmicSignalListMethod.Invoke(null, null);
        }
...
#pragma warning disable IDE1006 // Naming rule violation
        ...
        private ref struct kosmicsharp_property_info
        {
            // Careful with padding...
            public kosmic_string_name Name; // Not owned
            public kosmic_string HintString;
            public int Type;
            public int Hint;
            public int Usage;
            public kosmic_bool Exported;
...
#pragma warning restore IDE1006
        ...
        internal static unsafe void GetPropertyInfoList(IntPtr scriptPtr,
            delegate* unmanaged<IntPtr, kosmic_string*, void*, int, void> addPropInfoFunc)
        {
            try
            {
                Type scriptType = _scriptTypeBiMap.GetScriptType(scriptPtr);
            ...
            delegate* unmanaged<IntPtr, kosmic_string*, void*, int, void> addPropInfoFunc)
        {
            try
            {
                var getKosmicPropertyListMethod = type.GetMethod(
                    "GetKosmicPropertyList",
                    BindingFlags.DeclaredOnly | BindingFlags.Static |
                    BindingFlags.NonPublic | BindingFlags.Public);

                if (getKosmicPropertyListMethod == null)
                    return;

                var properties = (List<PropertyInfo>?)
                    getKosmicPropertyListMethod.Invoke(null, null);
                ...
                // StackMaxSize = StackMaxLength * sizeof(kosmicsharp_property_info)
                const int StackMaxLength = 32;
                bool useStack = length < StackMaxLength;

                kosmicsharp_property_info* interopProperties;
                ...
                if (useStack)
                {
                    ...
                    var aux = stackalloc kosmicsharp_property_info[StackMaxLength];
                    interopProperties = aux;
                }
                else
                {
                    interopProperties = ((kosmicsharp_property_info*)NativeMemory.Alloc(
                        (nuint)length, (nuint)sizeof(kosmicsharp_property_info)))!;
                }
                ...
                try
                {
                    for (int i = 0; i < length; i++)
                    {
                        ...
                        kosmicsharp_property_info interopProperty = new()
                        {
                            Type = (int)property.Type,
                            Name = (kosmic_string_name)property.Name.NativeValue, // Not owned
                    ...
                    using kosmic_string currentClassName = Marshaling.ConvertStringToNative(ReflectionUtils.ConstructTypeName(type));
...
#pragma warning disable IDE1006 // Naming rule violation
        ...
        // ReSharper disable once NotAccessedField.Local
        [StructLayout(LayoutKind.Sequential)]
        private ref struct kosmicsharp_property_def_val_pair
        {
            // Careful with padding...
            public kosmic_string_name Name; // Not owned
            public kosmic_variant Value; // Not owned
        }
#pragma warning restore IDE1006

        private delegate bool InvokeKosmicClassStaticMethodDelegate(in kosmic_string_name method, NativeVariantPtrArgs args, out kosmic_variant ret);

        [UnmanagedCallersOnly]
        internal static unsafe kosmic_bool CallStatic(IntPtr scriptPtr, kosmic_string_name* method,
            kosmic_variant** args, int argCount, kosmic_variant_call_error* refCallError, kosmic_variant* ret)
        {
            ...
            try
            {
                ...
                Type? top = scriptType;
                Type native = KosmicObject.InternalGetClassNativeBase(top);

                while (top != null && top != native)
                {
                    var invokeKosmicClassStaticMethod = top.GetMethod(
                        "InvokeKosmicClassStaticMethod",
                        BindingFlags.DeclaredOnly | BindingFlags.Static |
                        BindingFlags.NonPublic | BindingFlags.Public);

                    if (invokeKosmicClassStaticMethod != null)
                    {
                        var invoked = invokeKosmicClassStaticMethod.CreateDelegate<InvokeKosmicClassStaticMethodDelegate>()(
                            CustomUnsafe.AsRef(method), new NativeVariantPtrArgs(args, argCount), out kosmic_variant retValue);
                        if (invoked)
                        {
                            *ret = retValue;
                            return kosmic_bool.True;
            ...
            delegate* unmanaged<IntPtr, void*, int, void> addDefValFunc)
        {
            try
            {
                var getKosmicPropertyDefaultValuesMethod = type.GetMethod(
                    "GetKosmicPropertyDefaultValues",
                    BindingFlags.DeclaredOnly | BindingFlags.Static |
                    BindingFlags.NonPublic | BindingFlags.Public);

                if (getKosmicPropertyDefaultValuesMethod == null)
                    return;

                var defaultValuesObj = getKosmicPropertyDefaultValuesMethod.Invoke(null, null);
                ...
                // There's no recursion here, so it's ok to go with a big enough number for most cases
                // StackMaxSize = StackMaxLength * sizeof(kosmicsharp_property_def_val_pair)
                const int StackMaxLength = 32;
                bool useStack = length < StackMaxLength;

                kosmicsharp_property_def_val_pair* interopDefaultValues;

                if (useStack)
                {
                    // Weird limitation, hence the need for aux:
                    // "In the case of pointer types, you can use a stackalloc expression only in a local variable declaration to initialize the variable."
                    var aux = stackalloc kosmicsharp_property_def_val_pair[StackMaxLength];
                    interopDefaultValues = aux;
                }
                else
                {
                    interopDefaultValues = ((kosmicsharp_property_def_val_pair*)NativeMemory.Alloc(
                        (nuint)length, (nuint)sizeof(kosmicsharp_property_def_val_pair)))!;
                }
                ...
                try
                {
                    ...
                    {
                        kosmicsharp_property_def_val_pair interopProperty = new()
                        {
                            Name = (kosmic_string_name)defaultValuePair.Key.NativeValue, // Not owned
                            Value = (kosmic_variant)defaultValuePair.Value.NativeVar // Not owned
                        };
        ...
        [UnmanagedCallersOnly]
        internal static unsafe kosmic_bool SwapGCHandleForType(IntPtr oldGCHandlePtr, IntPtr* outNewGCHandlePtr,
            kosmic_bool createWeak)
        {
            try
            {
                ...
                if (target == null)
                {
                    ...
                    *outNewGCHandlePtr = IntPtr.Zero;
                    return kosmic_bool.False; // Called after the managed side was collected, so nothing to do here
                }
