...
namespace Kosmic
{
    ...
    {
        internal kosmic_node_path.movable NativeValue;
        ...
        private NodePath(kosmic_node_path nativeValueToOwn)
        {
            NativeValue = (kosmic_node_path.movable)nativeValueToOwn;
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        // Explicit name to make it very clear
        internal static NodePath CreateTakingOwnershipOfDisposableValue(kosmic_node_path nativeValueToOwn)
        ...
        public NodePath(string path)
        {
            ...
            {
                NativeValue = (kosmic_node_path.movable)NativeFuncs.kosmicsharp_node_path_new_from_string(path);
                _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
            }
        }
        ...
        public override string ToString()
        {
            ...
            var src = (kosmic_node_path)NativeValue;
            NativeFuncs.kosmicsharp_node_path_as_string(out kosmic_string dest, src);
            using (dest)
        ...
        /// KS.Print(propertyPath); // :position:x
        /// </code>
        /// </example>
        /// <returns>The <see cref="NodePath"/> as a pure property path.</returns>
        public NodePath GetAsPropertyPath()
        {
            kosmic_node_path propertyPath = default;
            var self = (kosmic_node_path)NativeValue;
            NativeFuncs.kosmicsharp_node_path_get_as_property_path(self, ref propertyPath);
        ...
        /// KS.Print(nodepath.GetConcatenatedNames()); // Path2D/PathFollow2D/Sprite2D
        /// </code>
        /// </example>
        ...
        {
            var self = (kosmic_node_path)NativeValue;
            NativeFuncs.kosmicsharp_node_path_get_concatenated_names(self, out kosmic_string names);
            using (names)
        ...
        /// <code>
        /// var nodepath = new NodePath("Path2D/PathFollow2D/Sprite2D:texture:load_path");
        /// KS.Print(nodepath.GetConcatenatedSubnames()); // texture:load_path
        /// </code>
        /// </example>
        ...
        {
            var self = (kosmic_node_path)NativeValue;
            NativeFuncs.kosmicsharp_node_path_get_concatenated_subnames(self, out kosmic_string subNames);
            using (subNames)
        ...
        /// KS.Print(nodePath.GetName(0)); // Path2D
        /// KS.Print(nodePath.GetName(1)); // PathFollow2D
        /// KS.Print(nodePath.GetName(2)); // Sprite
        /// </code>
        /// </example>
        ...
        {
            var self = (kosmic_node_path)NativeValue;
            NativeFuncs.kosmicsharp_node_path_get_name(self, idx, out kosmic_string name);
            using (name)
        ...
        {
            var self = (kosmic_node_path)NativeValue;
            return NativeFuncs.kosmicsharp_node_path_get_name_count(self);
        }
        ...
        {
            var self = (kosmic_node_path)NativeValue;
            NativeFuncs.kosmicsharp_node_path_get_subname(self, idx, out kosmic_string subName);
            using (subName)
        ...
        {
            var self = (kosmic_node_path)NativeValue;
            return NativeFuncs.kosmicsharp_node_path_get_subname_count(self);
        }
        ...
        {
            var self = (kosmic_node_path)NativeValue;
            return NativeFuncs.kosmicsharp_node_path_is_absolute(self).ToBool();
        }
        ...
        public bool Equals([NotNullWhen(true)] NodePath? other)
        {
            if (other is null)
                return false;
            var self = (kosmic_node_path)NativeValue;
            var otherNative = (kosmic_node_path)other.NativeValue;
            return NativeFuncs.kosmicsharp_node_path_equals(self, otherNative).ToBool();
        }
        ...
        {
            var self = (kosmic_node_path)NativeValue;
            return NativeFuncs.kosmicsharp_node_path_hash(self);
        }
    }
}
