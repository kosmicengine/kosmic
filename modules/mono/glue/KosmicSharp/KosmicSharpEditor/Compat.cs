...
{
    /// <inheritdoc cref="CreateAction(string, UndoRedo.MergeMode, KosmicObject, bool)"/>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public void CreateAction(string name, UndoRedo.MergeMode mergeMode, KosmicObject customContext)
    {
