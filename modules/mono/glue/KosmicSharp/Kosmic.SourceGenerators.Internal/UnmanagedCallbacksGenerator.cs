...
namespace Kosmic.SourceGenerators.Internal;
        ...
        foreach (var callback in data.Methods)
        {
            ...
            for (int i = 0; i < callback.Parameters.Length; i++)
            {
                ...
                if (parameter.RefKind == RefKind.Out)
                {
                    ...
                    if (IsKosmicInteropStruct(parameter.Type))
...
");
        ...
        foreach (var callback in data.Methods)
        {
            ...
            foreach (var parameter in callback.Parameters)
            {
                if (IsByRefParameter(parameter))
                {
                    if (IsKosmicInteropStruct(parameter.Type) || parameter.Type.IsValueType)
                    {
    ...
    private static bool IsKosmicInteropStruct(ITypeSymbol type) =>
        _kosmicInteropStructs.Contains(type.FullQualifiedNameOmitGlobal());
    ...
    private static readonly string[] _kosmicInteropStructs =
    {
        "Kosmic.NativeInterop.kosmic_ref",
        "Kosmic.NativeInterop.kosmic_variant_call_error",
        "Kosmic.NativeInterop.kosmic_variant",
        "Kosmic.NativeInterop.kosmic_string",
        "Kosmic.NativeInterop.kosmic_string_name",
        "Kosmic.NativeInterop.kosmic_node_path",
        "Kosmic.NativeInterop.kosmic_signal",
        "Kosmic.NativeInterop.kosmic_callable",
        "Kosmic.NativeInterop.kosmic_array",
        "Kosmic.NativeInterop.kosmic_dictionary",
        "Kosmic.NativeInterop.kosmic_packed_byte_array",
        "Kosmic.NativeInterop.kosmic_packed_int32_array",
        "Kosmic.NativeInterop.kosmic_packed_int64_array",
        "Kosmic.NativeInterop.kosmic_packed_float32_array",
        "Kosmic.NativeInterop.kosmic_packed_float64_array",
        "Kosmic.NativeInterop.kosmic_packed_string_array",
        "Kosmic.NativeInterop.kosmic_packed_vector2_array",
        "Kosmic.NativeInterop.kosmic_packed_vector3_array",
        "Kosmic.NativeInterop.kosmic_packed_vector4_array",
        "Kosmic.NativeInterop.kosmic_packed_color_array",
    };
}
